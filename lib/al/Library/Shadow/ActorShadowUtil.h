...
s32 getDepthShadowMapNum(LiveActor*);
...
void setShadowMaskDropLengthEvenWithTarget(ShadowMaskBase*, const ShadowMaskBase*, const sead::Vector3f&);
void setShadowMaskDropLengthEvenWithDrawCategory(LiveActor*, ShadowMaskDrawCategory, const LiveActor*, const char*);
...
f32 getDepthShadowMapLength(const LiveActor*, const char*);
...
void setDepthShadowMapBoundingBox(const LiveActor*, const sead::Vector3f&, const sead::Vector3f&, const char*);
...
void calcSphereDoBoundingInfo(sead::Vector3f*, sead::Vector3f*, f32*, f32*, const LiveActor*, const char*, f32);
...
void* getOcclusionSphere(const LiveActor*, const char*);
